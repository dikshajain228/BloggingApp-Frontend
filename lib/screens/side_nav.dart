...
import 'package:sidenavi/pages/profile_page.dart';
...
class _SideNavState extends State<SideNav> {
  String currentProfilePic = "https://github.com/battulapragati/picture/blob/master/unnamed.png";
 
  Widget build(BuildContext context) {
   
     
          return new Scaffold(
           appBar: new AppBar(title: new Text("Blogging App"), backgroundColor: Colors.redAccent),
           drawer: new Drawer(
             child:new ListView(
               children: <Widget>[
      ...
      body: new Center(
        child: new Text("Dummy Page", style: new TextStyle(fontSize: 35.0),
        ),
      ),);
  }
}
