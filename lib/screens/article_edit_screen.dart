...
class ArticleEditScreenState extends State<ArticleEditScreen> {
  ...
  void initState() {
    ...
    receivedcontent = receivedcontent.toString();
    final presentcontent = jsonEncode(receivedcontent);
    
    
    String receivedTitle;
    receivedTitle = receivedTitle.toString();
    final presentTitle = jsonEncode(receivedTitle);

    final Delta delta = Delta()..insert(presentcontent);
    final document = NotusDocument.fromDelta(delta);
    _controller = ZefyrController(document);
    _focusNode = FocusNode();


    final Delta delta1 = Delta()..insert(presentTitle);
